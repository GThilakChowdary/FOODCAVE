...
<head>
    ...
    <title>About Us | VIGNAN CAFE</title>
</head>
...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
                <img src="img/Color logo - no background.png" width="125" class="me-2" alt="VIGANA CAFE Logo">
            </a>
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal ">Vignan Institute Of Technology and Science</h4>
            ...
            <h4 class="mt-2 mb-3 fw-normal ">Guide Name</h4><p class="mt-2 mb-3 fw-normal h6 ">Dr. G. Raja Vikram</p>
